...
- **CPP Modules**: C++ Piscine projects.
  - [CPP Modules/](https://github.com/Prvdnx/42-CPP_MODULES)
- **FdF**: 3D Wireframe Rasterizer.
  - [FdF/](https://github.com/Prvdnx/42-FdF)
- **Inception**: System Administration and Docker.
  - [Inception/](https://github.com/Prvdnx/42_Inception)
- **NetPractice**: Networking exercises.
  - [NetPractice/](https://github.com/Prvdnx/42-NetPractice)
- **Philosophers**: Concurrency with threads and mutexes.
  - [Philosophers/](https://github.com/Prvdnx/42-Philosophers)
- **ft_irc**: Internet Relay Chat server.
  - [ft_irc/](https://github.com/TanawatJukmongkol/ft_irc)
- **ft_libft**: Custom C Standard Library implementation.
  - [ft_libft/](https://github.com/Prvdnx/42-ft_libft)
- **ft_printf**: Recreating the printf function.
  - [ft_printf/](https://github.com/Prvdnx/42-ft_printf)
- **get_next_line**: Reading a line from a file descriptor.
  - [get_next_line/](https://github.com/Prvdnx/42-get_next_line)
- **miniRT**: Ray Tracing with C.
  - [miniRT/](https://github.com/gs313/miniRT)
- **minitalk**: Small client-server communication using signals.
  - [minitalk/](https://github.com/Prvdnx/42-minitalk)
- **push_swap**: Stack sorting algorithm.
  - [push_swap/](https://github.com/Prvdnx/42-push_swap)
- **transcendence**: Real-time multiplayer Pong web application.
  - [transcendence/](https://github.com/bpassael/transcendence)
