        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.dailyListContainer}>
            ...
            {forecastData.map((item, index) => {
              // For the first day, display "Today", for the others, get the day of the week
...
const styles = StyleSheet.create({
  ...
  chartContainer: { backgroundColor: 'rgba(255, 255, 255, 0.9)', marginHorizontal: 20, marginTop: 20, marginBottom: 10,
     borderRadius: 12, padding: 16, },
  chartTitle: { fontSize: 18, fontWeight: '600', color: '#333', textAlign: 'center', marginBottom: 16, },
  dailyListContainer: { backgroundColor: 'rgba(255, 255, 255, 0.9)', marginHorizontal: 20, marginBottom: 20, borderRadius: 12, padding: 16, },
  listTitle: { fontSize: 18, fontWeight: '600', color: '#333', marginBottom: 16, },
  dailyItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1,
  ...
  maxTemp: { fontSize: 16, fontWeight: '600', color: '#333' },
  minTemp: { fontSize: 14, color: '#666' },
});
