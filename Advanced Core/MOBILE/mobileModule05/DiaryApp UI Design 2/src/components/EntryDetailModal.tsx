    ...
    <div className="fixed inset-0 bg-black/50 flex items-end justify-center z-50 animate-fadeIn">
      <div className="bg-white dark:bg-[#1A1A2E] w-full max-w-[390px] rounded-t-3xl shadow-2xl animate-slideUp transition-colors duration-300">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
          ...
          <h3 className="text-[#1C1C1E] dark:text-white transition-colors duration-300" style={{ fontSize: '18px', fontWeight: '600' }}>Entry Details</h3>
          <button
            onClick={onDelete}
            className="w-8 h-8 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center justify-center text-red-500"
          >
        ...
        <div className="p-6 max-h-[600px] overflow-y-auto">
          ...
          {/* Title */}
          <h2 className="text-[#1C1C1E] dark:text-white mb-4 transition-colors duration-300" style={{ fontSize: '24px', fontWeight: '600' }}>
            {entry.title}
          </h2>

          {/* Content */}
          <div className="bg-gray-50 dark:bg-[#0F0F1E] rounded-2xl p-4 transition-colors duration-300">
