    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        <LinearGradient colors={['#5B8CFF', '#4A7AE8']} style={styles.header}>
          ...
          <Calendar
            current={'2025-11-20'} onDayPress={(day) => setSelectedDate(day.dateString)}
            markedDates={{
            ...
            theme={{ calendarBackground: 'transparent', dayTextColor: '#FFFFFF', textDisabledColor: 'rgba(255, 255, 255, 0.5)',
