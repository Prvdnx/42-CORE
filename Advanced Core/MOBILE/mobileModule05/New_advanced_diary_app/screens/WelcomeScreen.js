...
const getStyles = (colors) => StyleSheet.create({
  ...
  dividerText: { marginHorizontal: 16, color: colors.secondaryText,},
  secondaryButton: { backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
                  shadowOpacity: 0.18, shadowRadius: 1.00, elevation: 1, },
  secondaryButtonText: { color: colors.text, fontSize: 16, fontWeight: '500', marginLeft: 12, },
});
