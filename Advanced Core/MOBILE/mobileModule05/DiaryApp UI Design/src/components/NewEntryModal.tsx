    ...
    <div className="fixed inset-0 bg-black/50 flex items-end justify-center z-50 animate-fadeIn">
      <div className="bg-white w-full max-w-[390px] rounded-t-3xl shadow-2xl animate-slideUp">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-[#1C1C1E]" style={{ fontSize: '20px', fontWeight: '600' }}>New Entry</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6 max-h-[600px] overflow-y-auto">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#5B8CFF] transition-all"
            />
          </div>
          ...
          {/* Feeling */}
          <div className="mb-4">
            <label className="block text-gray-700 text-sm mb-2">How are you feeling?</label>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#5B8CFF] transition-all resize-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-[#5B8CFF] text-white py-4 rounded-2xl shadow-lg hover:bg-[#4A7BEF] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            Save Entry
          </button>
        </div>
