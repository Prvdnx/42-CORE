  ...
  return (
    <div className="bg-white rounded-3xl shadow-md p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <h3 className="text-[#1C1C1E]" style={{ fontSize: '18px', fontWeight: '600' }}>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${!dayInfo.isCurrentMonth ? 'text-gray-300' : 'text-[#1C1C1E]'}
                ${isSelectedDate ? 'bg-[#5B8CFF] text-white scale-105 shadow-lg' : 'hover:bg-gray-100'}
