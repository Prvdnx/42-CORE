...
export default function App() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-screen bg-[#F5F7FA] flex items-center justify-center p-4">
        <div className="w-full max-w-[390px] h-[844px] bg-white rounded-3xl shadow-2xl overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] flex items-center justify-center p-4">
      <div className="w-full max-w-[390px] h-[844px] bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col">
          ...
          <div className="flex justify-around items-center h-20 px-6">
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${
                currentScreen === 'profile' ? 'text-[#5B8CFF]' : 'text-gray-400'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${
                currentScreen === 'agenda' ? 'text-[#5B8CFF]' : 'text-gray-400'
              }`}
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
